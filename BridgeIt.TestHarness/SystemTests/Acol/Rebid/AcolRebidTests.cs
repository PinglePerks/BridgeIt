...
public class AcolRebidTests
{
    ...
    [Test]
    public async Task OpenerRebid_AlwaysBids1NT_WithBalanced15to17()
    {
        // Generate 50 hands that are strictly 12-14 points and balanced
        var testDeals = _dealer.GenerateMultipleConstrainedDeals(50, HandSpecification.Acol1NtRebid, HandSpecification.AcolOpeningPass);
